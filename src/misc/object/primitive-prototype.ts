...
export const PRIMITIVE_PROTOTYPES = new Set<any>(['', 0, {}, [], () => {
}].map(_ => Object.getPrototypeOf(_)));

export function isPrimitivePrototype(
  proto: any,
): boolean {
  return PRIMITIVE_PROTOTYPES.has(proto);
}

export function isNotPrimitivePrototype(
  proto: any,
): boolean {
